...
class HardReset extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'photon:hard-reset';
     ...
     * @var string
     */
    protected $description = 'Performs the Photon Hard Reset action';
    ...
    public function handle()
    {
        ...
        $this->info('...Module Extenders removed');
