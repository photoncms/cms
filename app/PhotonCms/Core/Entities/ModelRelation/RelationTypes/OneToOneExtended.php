...
class OneToOneExtended extends BaseRelation implements ModelRelationInterface, MigrationRelationInterface, ModelRelationCanBeNullableInterface, ModelRelationCanBeDropped
{
