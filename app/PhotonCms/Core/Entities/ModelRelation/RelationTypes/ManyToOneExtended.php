...
class ManyToOneExtended extends BaseRelation implements ModelRelationInterface, MigrationRelationInterface, ModelRelationCanBeNullableInterface, ModelRelationCanBeDropped
{
    ...
    public function compile($amountOfIndent = 0)
    {
        ...
        $content .= "return \$this->belongsTo('{$this->targetModelNamespace}'";
        if ($this->sourceField) {
